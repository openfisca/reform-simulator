...
class PPAReform(reforms.Reform):
    def __init__(self, tax_benefit_system, ppa_pente=0.5):
        self.ppa_pente = ppa_pente
        super(PPAReform, self).__init__(tax_benefit_system)
...
def precalculate(france_tbs):
    ...
    # 101 because the PPA starts at first 1€ revenue
    for ppa_pente_int in range(0, 100, 10):
        ppa_pente = ppa_pente_int / 100.
        reform_tbs = PPAReform(france_tbs, ppa_pente)
